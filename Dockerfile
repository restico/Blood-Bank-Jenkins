...
COPY ./Blood-Bank-Management-System/ /var/www/blood_bank
...
RUN apt update -y \
     ...
     && apt update \
     && apt -y install php8.2 php8.2-mysql php8.2-gd php8.2-ldap php8.2-odbc  php8.2-xml php8.2-xmlrpc php8.2-mbstrin>
